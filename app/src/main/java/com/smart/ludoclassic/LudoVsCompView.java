...
public class LudoVsCompView extends View {
    ...
    class C03961 implements Comparator<Drawable> {
        C03961() {
        }
    ...
    public LudoVsCompView(Context context) {
        ...
        this.playerOutOfGame = new Integer[]{0, 0, 0, 0};
        ...
        this.playerPath = new int[][]{new int[]{92, 93, 94, 95, 96, 82, 67, 52, 37, 22, 7, 8, 9, 24, 39, 54, 69, 84, 100, 101, 102, 103, 104, 105, 120, 135, 134, 133, 132, 131, 130, 144, 159, 174, 189, 204, 219, 218, 217, 202, 187, 172, 157, 142, 126, 125, 124, 123, 122, 121, 106, 107, 108, 109, 110, 111, 112}, new int[]{24, 39, 54, 69, 84, 100, 101, 102, 103, 104, 105, 120, 135, 134, 133, 132,131, 130, 144, 159, 174, 189, 204, 219, 218, 217, 202, 187, 172, 157, 142, 126, 125, 124, 123, 122, 121, 106, 91, 92, 93, 94, 95, 96, 82, 67, 52, 37, 22, 7, 8, 23, 38, 53, 68, 83, 98}, new int[]{134, 133, 196, 131, 130, 144, 159, 174, 189, 204, 219, 218, 217, 202, 187, 172, 157, 142, 126, 125, 124, 123, 122, 121, 106, 91, 92, 93, 94, 95, 96, 82, 67, 52, 37, 22, 7, 8, 9, 24, 39, 54, 69, 84, 100, 101, 102, 103, 104, 105, 120, 119, 118, 117, 116, 115, 114}, new int[]{202, 187, 172, 157, 142, 126, 125, 124, 123, 122, 121, 106, 91, 92, 93, 94, 95, 96, 82, 67, 52, 37, 22, 7, 8, 9, 24, 39, 54, 69, 84, 100, 101, 102, 103, 104, 105, 120, 135, 134, 133, 132, 131, 130, 144, 159, 174, 189, 204, 219, 218, 203, 188, 173, 158, 143, 128}};
        ...
        this.markerReadyForClick = Boolean.FALSE;
        this.diceReadyForClick = Boolean.TRUE;
        this.gameComplete = Boolean.FALSE;
        this.diceValuePreviousWasSix = Boolean.FALSE;
        this.landedOnOpponentsToken = Boolean.FALSE;
        this.reachedHome = Boolean.FALSE;
    ...
    public LudoVsCompView(Context context, AttributeSet attrs) {
        ...
        this.playerOutOfGame = new Integer[]{Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0)};
        this.playerRankList = new ArrayList();
        this.rockPaintColors = new String[]{"YELLOW", "GREEN", "RED", "BLUE"};
        this.rockPaintListFill = new Paint[4];
        this.rockPaintListStroke = new Paint[4];
        ...
        this.gridBoxDpHeight = 0.0f;
        this.gridBoxDpWidth = 0.0f;
        this.f56k = Integer.valueOf(0);
        this.f57l = Integer.valueOf(0);
    ...
    private void gameLoop() {
        Collections.sort(this.markersInGameList, new C03961());
        this.gameLoopHandler.sleep(this.gameLoopDelay);
    }

    private void play() {
        if (LudoVsCompActivity.play.booleanValue()) {
            Iterator it;
            switch (this.gameState.intValue()) {
                case 0:
                    ...
                    return;
                case 1:
                    if (this.f57l.intValue() < this.maxDiceRolls.intValue()) {
                        this.f57l = Integer.valueOf(this.f57l.intValue() + 1);
