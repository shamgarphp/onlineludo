...
public class LudoTwoplayerView extends View {
    ...
    class C03901 implements Comparator<Drawable> {
        C03901() {
        }
    ...
    class GameLoopHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            LudoTwoplayerView.this.invalidate();
            LudoTwoplayerView.this.gameLoop();
        }
    ...
    public LudoTwoplayerView(Context context) {
        ...
        this.f52k = Integer.valueOf(0);
        this.f53l = Integer.valueOf(0);
    ...
    public LudoTwoplayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.currentBoxPlayer = new Integer[]{Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0)};
        this.playerOutOfGame = new Integer[]{Integer.valueOf(1), Integer.valueOf(0), Integer.valueOf(1), Integer.valueOf(0)};
        this.playerRankList = new ArrayList();
    ...
    public LudoTwoplayerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void gameLoop() {
        Collections.sort(this.markersInGameList, new C03901());
        this.gameLoopHandler.sleep(this.gameLoopDelay);
    }

    private void play() {
        if (LudoTwoplayerActivity.play.booleanValue()) {
            switch (this.gameState.intValue()) {
                case 0:
                    ...
                    return;
                case 1:
                    if (this.f53l.intValue() < this.maxDiceRolls.intValue()) {
                        this.f53l = Integer.valueOf(this.f53l.intValue() + 1);
