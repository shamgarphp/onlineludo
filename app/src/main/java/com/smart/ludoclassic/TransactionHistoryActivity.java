...
public class TransactionHistoryActivity extends SideMenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater.from(this).inflate(R.layout.activity_transaction_history,contentFrameLayout);
